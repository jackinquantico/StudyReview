...
public class MemberController {
	...
	public void insertMember(String userId, String userPwd, String userName, String gender
		...
		// 2. VO 객체 Service 메소드로 넘겨주기 (== Service 단의 메소드 호출)
		// 3. 결과 받기
	...
	public void selectAll() {
		...
		// 2. VO 객체를 Service 단의 메소드에 요청 (호출)
		// 3. 결과 받기
		// => Service 메소드 호출 시 생각해봐야하는 것 : 매개변수 X, 리턴타입 
	...
	public void selectByUserId(String userId) {
		...
		// 2. 전달값을 Service 로 넘기면서 메소드 호출
		// 3. 결과값 받기
		// => Service 메소드를 호출할 때 고려해야 할 것 : 매개변수 userId, 리턴타입 Member
